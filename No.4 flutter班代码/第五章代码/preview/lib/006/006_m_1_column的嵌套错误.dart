...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /*
    return Container(
      height: 400,//注意外层给高度不行,必须给Expanded所在的Column限制高度
      color: Colors.green,
      child: Column(
        children: <Widget>[
          Container(
            // height: 100,//当给内层的Column限制一个高度的时候,问题解决,这样内层的Expanded分配剩余空间的时候就有了确定的值
            color: Colors.yellow,
            child: Column(
              children: <Widget>[
                Text("111"),
       ...
       Container(
         ...
         child: Column(
              children: [
                Text("3333"),
                Text("4444"),
                Expanded(child: Text("5555")),
                Expanded(child: Text("6666"),)
              ],
            ),
       ),
        ],),
