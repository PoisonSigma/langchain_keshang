...
List<ShoppingCartItem> items = [];//把成员变量改成全局变量
...
class _ShoppingcartAppState extends State<ShoppingcartApp> {
  ...
  loadData() {
    items = [
      ShoppingCartItem(
          text: "南岗大呲花", img: "images/70kg.png", selected: false, count: 1),
      ShoppingCartItem(
          text: "道里小鞭儿", img: "images/70kg2.png", selected: false, count: 2),
      ShoppingCartItem(
          text: "香坊二踢脚", img: "images/wyz.jpeg", selected: false, count: 3),
      ShoppingCartItem(
          text: "彭于晏", img: "images/2024.jpeg", selected: false, count: 4),
      ShoppingCartItem(
          text: "吴彦祖2", img: "images/wyz.jpeg", selected: false, count: 10),
      ShoppingCartItem(
          text: "吴彦祖3", img: "images/wyz.jpeg", selected: false, count: 6)
    ];
  }
...
class HomePage extends StatefulWidget {
  ...
  HomePage({required this.isEditting});
              ...
              widget.isEditting
                  ? IconButton(
                      onPressed: () {
                        print("删除");
                        setState(() {
                          items.removeAt(index);//移除指定索引处的元素
                        });
                      },
                      icon: Icon(
                        Icons.remove_circle,
