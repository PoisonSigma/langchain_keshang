...
class Person2{
   external breath(); //有了external可以让普通class也能有没有方法体的方法
}
class Worker2 extends Person2{
  // @override
  // breath() {
  //   // TODO: implement breath
  //   // return super.breath();//不要用他默认生成的,因为父类中没有方法体
  //   print("工人呼吸了");
  // }
}
class Woker3 implements Person2{ //implements必须实现抽象方法
  @override
  breath() {
    // TODO: implement breath
    print("implements breath");
  }
